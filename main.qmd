...
For an explanation of each predicate, please see @sec-appendix-a. Some example computations of the Spanish function (2) are included in @sec-appendix-b.
...
This will have the Spain computations.